...
\begin{defn}
    ...
    We now first define the whiskering operations. Consider the diagram
	\begin{center}
		\begin{tikzcd}
	...
	\begin{center}
		\begin{tikzcd}
            I \ar[r, "\lambda^{-1}"] & I \otimes I \arrow[r, "\beta_{A}\otimes\alpha_{A}"] & \B(GA,HA) \otimes \B(FA,GA) \arrow[r, "\circ"] & \B(FA,HA)
		\end{tikzcd}
	\end{center}
