...
\begin{proof}
	...
	\end{tikzcd}
	\] 
	commutes by the naturality of $\sigma$. Since $S$ is well pointed, this implies $\sigma_a \alpha=S\alpha\circ\sigma_{Sa}=S\alpha\circ S\sigma_a=S(\alpha\sigma_a)=S(\id_a)=\id_{Sa}$. Therefore $\alpha=\sigma_a^{-1}$.
\end{proof}
