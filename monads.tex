...
\end{center}
    ...
    \end{rmk}
	\begin{prop}
		The functor $U^T\colon T-Alg\rightarrow\C$ has a left adjoint $F^T\colon\C\rightarrow T-Alg$ such that $F^Tc=(Tc,\mu_{c})$ and $F^Tf\colon(Tc,\mu_{c})\rightarrow (Td,\mu_{d})$.
	\end{prop}
